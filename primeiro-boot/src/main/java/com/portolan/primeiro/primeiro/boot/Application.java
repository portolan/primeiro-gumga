package com.portolan.primeiro.primeiro.boot;
...
@SpringBootApplication(scanBasePackages = {"com.portolan.primeiro.primeiro.boot.components",
                                           "com.portolan.primeiro.primeiro.application.service",
                                           "io.gumga",
                                           "com.portolan.primeiro.primeiro.api"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBeanForSpringBoot.class, basePackages = {"com.portolan.primeiro.primeiro.application.repository", "io.gumga"})
...
public class Application {
    ...
    public DataSource dataSource() {
        ...
        config.addDataSourceProperty("url", getProperties().getProperty("dataSource.url", "jdbc:h2:mem:primeiro;MVCC=true"));
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga.domain", "com.portolan.primeiro.primeiro.domain.model");
