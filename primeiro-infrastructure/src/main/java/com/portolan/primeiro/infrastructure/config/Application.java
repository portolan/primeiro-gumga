package com.portolan.primeiro.infrastructure.config;
...
@Configuration
@ComponentScan(basePackages = {"com.portolan.primeiro", "io.gumga"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBean.class, basePackages = {"com.portolan.primeiro", "io.gumga"})
...
public class Application {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga.domain","com.portolan.primeiro");
