...
import com.portolan.primeiro.primeiro.application.service.TurmaService;
...
public class TurmaAPI extends GumgaAPI<Turma, Long> {


    @Autowired
    public TurmaAPI(GumgaService<Turma, Long> service) {
        super(service);
    }
